...
height_second_std_deviation_start, height_second_std_deviation_end = height_mean - (height_stdev*2), height_mean+(height_stdev*2)
height_third_std_deviation_start, height_third_std_deviation_end = height_mean - (height_stdev*3), height_mean+(height_stdev*3)

weight_first_std_deviation_start, weight_first_std_deviation_end = weight_mean - weight_stdev, weight_mean+weight_stdev
weight_second_std_deviation_start, weight_second_std_deviation_end = weight_mean - (weight_stdev*2), weight_mean+(weight_stdev*2)
weight_third_std_deviation_start, weight_third_std_deviation_end = weight_mean - (weight_stdev*3), weight_mean+(weight_stdev*3)
